...
document.getElementById('contactForm')?.addEventListener('submit', function(e) {
    ...
    // Create mailto link
    const mailtoLink = `mailto:noble@artiststudio.com?subject=${encodeURIComponent(subject || 'Portfolio Inquiry')}&body=${encodeURIComponent(`Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`)}`;
...
const videoData = [
    { title: 'Painting Process', desc: 'Time-lapse Creation', src: 'assets/video1.mp4' },
    { title: 'Studio Tour', desc: 'Behind The Scenes', src: 'assets/video2.mp4' },
    { title: 'Art Techniques', desc: 'Tutorial & Tips', src: 'assets/video3.mp4' },
    { title: 'Exhibition Highlights', desc: 'Gallery Showcase', src: 'assets/video4.mp4' }
];
